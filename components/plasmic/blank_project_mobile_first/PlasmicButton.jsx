...
import sty from "./PlasmicButton.module.css"; // plasmic-import: PHLHvTFRvlq/css
import ChecksvgIcon from "./icons/PlasmicIcon__Checksvg"; // plasmic-import: 9abZ2zwH7WJ/icon
import IconIcon from "./icons/PlasmicIcon__Icon"; // plasmic-import: IU5NfN1NmDa/icon
      ...
      {(
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <ChecksvgIcon
                className={classNames(projectcss.all, sty.svg__nnY9J)}
                role={"img"}
              />
            ),
      ...
      {(hasVariant(variants, "showEndIcon", "showEndIcon") ? true : false) ? (
        ...
        >
          {p.renderPlasmicSlot({
            defaultContents: (
              <IconIcon
                className={classNames(projectcss.all, sty.svg__jtvZt)}
                role={"img"}
              />
            ),
